...
public class SeleneseTestBaseVir {
    ...
    private static String currentPlanName = "";
        ...
        if (browserName.contains("chrome") || browserName.contains("Chrome")) {
            ...
            edgeDriver =
                         new File("src" + File.separator + "main"
                                 + File.separator + "resources" + File.separator
                                 + "lib" + File.separator
                                 + "microsoftedgedriver.exe");
                 System.setProperty("webdriver.edge.driver",
                                                 edgeDriver.getAbsolutePath());

        }else if(browserName.contains("headless")){
                
                setBrowserString(browserString);
            setWebDriverCapabilities(new DesiredCapabilities());
            setDefaultProfile(new HtmlUnitDriver());
    ...
    private void setDefaultProfile(HtmlUnitDriver htmlUnitDriver) {
   ...
   public final boolean isProcessRunning(final String serviceName)
    ...
    public final String replaceXMLSpecialCharacters(final String text) {
        ...
        replaced = replaced.replaceAll(" ","&#160;"); 
        replaced = replaced.replaceAll("â‚¬", "&#128;");
        replaced = replaced.replaceAll("â€š", "&#130;");
        replaced = replaced.replaceAll("Æ’", "&#131;");
        replaced = replaced.replaceAll("â€ž", "&#132;");
        replaced = replaced.replaceAll("â€¦", "&#133;");
        replaced = replaced.replaceAll("â€ ", "&#134;");
        replaced = replaced.replaceAll("â€¡", "&#135;");
        replaced = replaced.replaceAll("Ë†", "&#136;");
        replaced = replaced.replaceAll("â€°", "&#137;");
        replaced = replaced.replaceAll("Å ", "&#138;");
        replaced = replaced.replaceAll("â€¹", "&#139;");
        replaced = replaced.replaceAll("Å’", "&#140;");
        replaced = replaced.replaceAll("Å½", "&#142;");
        replaced = replaced.replaceAll("â€˜", "&#145;");
        replaced = replaced.replaceAll("â€™", "&#146;");
        replaced = replaced.replaceAll("â€œ", "&#147;");
        replaced = replaced.replaceAll("â€�", "&#148;");
        replaced = replaced.replaceAll("â€¢", "&#149;");
        replaced = replaced.replaceAll("â€“", "&#150;");
        replaced = replaced.replaceAll("â€”", "&#151;");
        replaced = replaced.replaceAll("Ëœ", "&#152;");
        replaced = replaced.replaceAll("â„¢", "&#153;");
        replaced = replaced.replaceAll("Å¡", "&#154;");
        replaced = replaced.replaceAll("â€º", "&#155;");
        replaced = replaced.replaceAll("Å“", "&#156;");
        replaced = replaced.replaceAll("Å¾", "&#158;");
        replaced = replaced.replaceAll("Å¸", "&#159;");
        replaced = replaced.replaceAll("Â¡", "&#161;");
        ...
        replaced = replaced.replaceAll("Â¨", "&#168;");
        replaced = replaced.replaceAll("Â©", "&#169;");
        replaced = replaced.replaceAll("Âª", "&#170;");
        replaced = replaced.replaceAll("Â«", "&#171;");
        replaced = replaced.replaceAll("Â¬", "&#172;");
        replaced = replaced.replaceAll("Â¬", "&#173;");
        replaced = replaced.replaceAll("Â®", "&#174;");
        ...
        replaced = replaced.replaceAll("Â³", "&#179;");
        replaced = replaced.replaceAll("Â´", "&#180;");
        replaced = replaced.replaceAll("Âµ", "&#181;");
        replaced = replaced.replaceAll("Â¶", "&#182;");
        replaced = replaced.replaceAll("Â·", "&#183;");
        replaced = replaced.replaceAll("Â¸", "&#184;");
        replaced = replaced.replaceAll("Â¹", "&#185;");
        replaced = replaced.replaceAll("Âº", "&#186;");
        replaced = replaced.replaceAll("Â»", "&#187;");
        replaced = replaced.replaceAll("Â¼", "&#188;");
        replaced = replaced.replaceAll("Â½", "&#189;");
        replaced = replaced.replaceAll("Â¾", "&#190;");
        replaced = replaced.replaceAll("Â¿", "&#191;");
        replaced = replaced.replaceAll("Ã€", "&#192;");
        replaced = replaced.replaceAll("Ã�", "&#193;");
        replaced = replaced.replaceAll("Ã‚", "&#194;");
        replaced = replaced.replaceAll("Ãƒ", "&#195;");
        replaced = replaced.replaceAll("Ã„", "&#196;");
        replaced = replaced.replaceAll("Ã…", "&#197;");
        replaced = replaced.replaceAll("Ã†", "&#198;");
        replaced = replaced.replaceAll("Ã‡", "&#199;");
        replaced = replaced.replaceAll("Ãˆ", "&#200;");
        replaced = replaced.replaceAll("Ã‰", "&#201;");
        replaced = replaced.replaceAll("ÃŠ", "&#202;");
        replaced = replaced.replaceAll("Ã‹", "&#203;");
        replaced = replaced.replaceAll("ÃŒ", "&#204;");
        replaced = replaced.replaceAll("Ã�", "&#205;");
        replaced = replaced.replaceAll("ÃŽ", "&#206;");
        replaced = replaced.replaceAll("Ã�", "&#207;");
        replaced = replaced.replaceAll("Ã�", "&#208;");
        replaced = replaced.replaceAll("Ã‘", "&#209;");
        replaced = replaced.replaceAll("Ã’", "&#210;");
        replaced = replaced.replaceAll("Ã“", "&#211;");
        replaced = replaced.replaceAll("Ã”", "&#212;");
        replaced = replaced.replaceAll("Ã•", "&#213;");
        replaced = replaced.replaceAll("Ã–", "&#214;");
        replaced = replaced.replaceAll("Ã—", "&#215;");
        replaced = replaced.replaceAll("Ã˜", "&#216;");
        replaced = replaced.replaceAll("Ã™", "&#217;");
        replaced = replaced.replaceAll("Ãš", "&#218;");
        replaced = replaced.replaceAll("Ã›", "&#219;");
        replaced = replaced.replaceAll("Ãœ", "&#220;");
        replaced = replaced.replaceAll("Ã�", "&#221;");
        replaced = replaced.replaceAll("Ãž", "&#222;");
        replaced = replaced.replaceAll("ÃŸ", "&#223;");
        replaced = replaced.replaceAll("Ã ", "&#224;");
        replaced = replaced.replaceAll("Ã¡", "&#225;");
        replaced = replaced.replaceAll("Ã¢", "&#226;");
        replaced = replaced.replaceAll("Ã£", "&#227;");
        replaced = replaced.replaceAll("Ã¤", "&#228;");
        replaced = replaced.replaceAll("Ã¥", "&#229;");
        replaced = replaced.replaceAll("Ã¦", "&#230;");
        replaced = replaced.replaceAll("Ã§", "&#231;");
        replaced = replaced.replaceAll("Ã¨", "&#232;");
        replaced = replaced.replaceAll("Ã©", "&#233;");
        replaced = replaced.replaceAll("Ãª", "&#234;");
        replaced = replaced.replaceAll("Ã«", "&#235;");
        replaced = replaced.replaceAll("Ã¬", "&#236;");
        replaced = replaced.replaceAll("Ã­", "&#237;");
        replaced = replaced.replaceAll("Ã®", "&#238;");
        replaced = replaced.replaceAll("Ã¯", "&#239;");
        replaced = replaced.replaceAll("Ã°", "&#240;");
        replaced = replaced.replaceAll("Ã±", "&#241;");
        replaced = replaced.replaceAll("Ã²", "&#242;");
        replaced = replaced.replaceAll("Ã³", "&#243;");
        replaced = replaced.replaceAll("Ã´", "&#244;");
        replaced = replaced.replaceAll("Ãµ", "&#245;");
        replaced = replaced.replaceAll("Ã¶", "&#246;");
        replaced = replaced.replaceAll("Ã·", "&#247;");
        replaced = replaced.replaceAll("Ã¸", "&#248;");
        replaced = replaced.replaceAll("Ã¹", "&#249;");
        replaced = replaced.replaceAll("Ãº", "&#250;");
        replaced = replaced.replaceAll("Ã»", "&#251;");
        replaced = replaced.replaceAll("Ã¼", "&#252;");
        replaced = replaced.replaceAll("Ã½", "&#253;");
        replaced = replaced.replaceAll("Ã¾", "&#254;");
        replaced = replaced.replaceAll("Ã¿", "&#255;");
        return (replaced.replaceAll("Ã¢â€šÂ¬", "&#8364;"));
    ...
    public final WebDriver getDriver() {
        return VtafThreadLocalClass.getTestCaseUnit().getDriver();
    }
    ...
    return orientDatabaseInstances;
                ...
                public static void setCurrentPlanName(String currentPlanName) {
                                SeleneseTestBaseVir.currentPlanName = currentPlanName;
                }
                ...
                public static void setBuildVersion(String buildVersion) {
                                SeleneseTestBaseVir.buildVersion = buildVersion;
                }
                ...
                public static void setReleaseVersion(String releaseVersion) {
                                SeleneseTestBaseVir.releaseVersion = releaseVersion;
                }
